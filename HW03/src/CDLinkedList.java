public class CDLinkedList {
	...
	public void swapRange(Iterator s1, Iterator f1, Iterator s2, Iterator f2) throws Exception{
		...
		if (size() < 2 || s1 == null || f1 == null || s2 == null || f2 == null) {
			return;
		}
		...
		DListIterator s11 = (DListIterator) s1;
		DListIterator f11 = (DListIterator) f1;
		DListIterator s22 = (DListIterator) s2;
		DListIterator f22 = (DListIterator) f2;
		
		//pointers that point in
		
		s11.currentNode.previousNode.nextNode = s22.currentNode;
		f22.currentNode.nextNode.previousNode = f11.currentNode;
		s22.currentNode.previousNode.nextNode = s11.currentNode;
		f11.currentNode.nextNode.previousNode = f22.currentNode;
		
		//pointers that point out
		
		DListNode temp1 = s11.currentNode.previousNode;
		s11.currentNode.previousNode = s22.currentNode.previousNode;
		s22.currentNode.previousNode = temp1;
		
		DListNode temp2 = f22.currentNode.nextNode;
		f22.currentNode.nextNode = f11.currentNode.nextNode;
		f11.currentNode.nextNode = temp2;
