public class BSTRecursive {
	...
	public int numNodesLessThan(BSTNode n, int v) {
		if (n == null) {
			...
			return numNodesLessThan(n.left, v) + numNodesLessThan(n.right, v) + 1;
		} else {
			return numNodesLessThan(n.left, v) + numNodesLessThan(n.right, v);
		}
	}
	...
	public int numLeavesLessThan(BSTNode n, int v) {
		if (n == null) {
			return 0;
		} else if (n.data < v && n.left == null && n.right == null) {
			return 1;
		} else if (n.data >= v && n.left == null && n.right == null) {
			return 0;
		} else if (n.left != null || n.right != null) {
